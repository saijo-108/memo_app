...
<html lang="ja">
  ...
  <body>
    ...
    <div id="sh">
      <h1 class="logo">
        <a href="/memo_app/index.php"><img src="/memo_app/images/logo9.png" alt="Sample Site" /></a>
      </h1>
      <nav id="menubar-s">
        <ul>
          <!-- ログインしている時表示するもの -->
          ...
          <?php else: ?>
            ...
            <li>
              <a href="/memo_app/login.php" class="text_blue"><span>ログイン</span>Login</a>
            </li>
          <?php endif; ?>
        </ul>
      </nav>
    ...
    <div id="sub">
      ...
      <h1 class="logo">
        <a href="/memo_app/index.php"
          ><img src="/memo_app/images/logo9.png" alt="Sample Site"
        /></a>
      </h1>
